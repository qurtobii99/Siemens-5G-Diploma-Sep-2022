...
int main() {
    ...
    */
    ...
    //Test the Demapper using the o/p of the mapper
    DemapperObj.Demapper_TurnOn(MapperObj.Mapper_GetOutput());
    DemapperObj.Demapper_PrintOutput();

    scramblerObj.Scrambler_TurnOn(MapperObj.Mapper_GetOutput());
    scramblerObj.Scrambler_PrintOutput();

    //Test the Descrambler using the o/p of the scrambler
    ...
    CPAObj.CyclicPrefixAdder_TurnOn(ModulatorObj.Modulator_GetOutput());
